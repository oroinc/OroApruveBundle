...
class PurchasePaymentActionTest extends \PHPUnit\Framework\TestCase
{
    ...
    private const SECURE_HASH = '6c6b4a10f9afc452a065051ff42da575264d937f77888b4397fd85d0c12d2109';
    ...
    public function testExecute()
    {
        ...
        $this->apruveOrderFromPaymentContextFactory->expects(self::once())
            ->method('createFromPaymentContext')
            ->with($this->paymentContext, $this->config)
            ->willReturn($this->apruveOrder);

        $this->orderSecureHashGenerator->expects(self::once())
            ->method('generate')
        ...
        self::assertSame(self::REQUEST_DATA, $actual);
    }
    ...
    public function testExecuteWithoutPaymentContext()
    {
        ...
        $this->apruveOrderFromPaymentContextFactory->expects(self::never())
            ->method('createFromPaymentContext');
    ...
    public function testGetName()
    {
        ...
        self::assertSame(PurchasePaymentAction::NAME, $actual);
    }
}
