...
class SignatureVerifyingServiceTest extends TestCase
{
    ...
    public function testVerifyRequestSignature(): void
    {
        ...
        $this->apruvePublicKeyProvider->expects(self::once())
            ->method('getPublicKey')
    ...
    public function testVerifyRequestSignatureFalse(): void
    {
        ...
        self::assertFalse($this->signatureVerifyingService->verifyRequestSignature($request));
    }
    ...
    private function getCorrectSignature(): string
    {
